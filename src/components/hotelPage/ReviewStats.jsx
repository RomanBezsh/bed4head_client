const ReviewStats = () => {
  ...
  return (
    <div className="w-full max-w-275 mt-16 gap-8 flex flex-col items-center mx-auto">
      <h3 className="text-[16px] text-[#717171] uppercase">Guest reviews</h3>
  ...
  return (
    <div className="flex flex-col items-center justify-between">
      <div className="relative w-20 h-30 flex items-center justify-center">
        ...
        <span className="absolute text-[32px] text-[#581ADB]">{score}</span>
      </div>

      <span className="mt-2 text-[16px] uppercase text-[#581ADB]">{label}</span>
    </div>
  );
};
