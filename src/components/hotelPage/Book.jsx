...
const Book = React.forwardRef(({ rooms, loading }, ref) => {
    if (loading) {
        return (
            <section ref={ref} className="flex flex-col items-center gap-6 sm:gap-8 mt-14 sm:mt-16 lg:mt-20 mb-14 sm:mb-16 lg:mb-20 px-4 sm:px-6">
